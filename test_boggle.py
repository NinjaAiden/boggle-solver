...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_coordinates(self):
        """
        Test to ensure all coordinates inside grid can be accessed
        """
    ...
    def test_grid_is_filled_with_letters(self):
        """
        Ensure grid is filled with letters and that they are
        all uppercase
        """
        grid = boggle.make_grid(2, 3)
    ...
    def test_converting_a_path_to_a_word(self):
        """
        Ensure that a path can be converted into words
        """
        grid = boggle.make_grid(2, 2)
    ...
    def test_search_grid_for_words(self):
        ...
        fullwords = [twoLeterWord, threeLetterWord, notThereWord]
        stems = ['A', 'AB', 'E', 'EE']
